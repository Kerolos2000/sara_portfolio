...
export const Loader: React.FC<LoaderProps> = () => {
    ...
    return (
        <Box sx={{
            display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', position: 'fixed',
            zIndex: theme.zIndex.drawer + 1, top: 0, left: 0, right: 0, bottom: 0,
            backgroundColor: alpha(theme.palette.background.default, 0.95), backdropFilter: 'blur(5px)',
        }}>
